...
import com.sasha.asuna.mod.feature.impl.chat.*;
import com.sasha.asuna.mod.feature.impl.combat.*;
import com.sasha.asuna.mod.feature.impl.gui.*;
import com.sasha.asuna.mod.feature.impl.misc.*;
import com.sasha.asuna.mod.feature.impl.movement.*;
...
public class AsunaMod implements SimpleListener {
    ...
    private void registerFeaturesOld() {
        ...
        Manager.Feature.registerFeature(new InventoryMoveFeature());
        Manager.Feature.registerFeature(new QuickUseFeature());
        //Manager.Feature.registerFeature(new FluidInteractFeature()); todo
