...
import com.sasha.asuna.mod.feature.impl.gui.FramerateRenderableFeature;
...
public class RenderableFramerate extends RenderableObject {
    ...
    public void renderObjectLT(int yyy) {
        AsunaMod.FONT_MANAGER.segoe_36.drawStringWithShadow("\247" + "fFPS" + "\247" + "7: " + formatFPS(Minecraft.getDebugFPS()), 4, yyy, 0xffffff);
    }
