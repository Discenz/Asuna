...
import com.sasha.asuna.mod.events.client.ClientRenderFireOverlayEvent;
...
public class AntiFireOverlayFeature extends AbstractAsunaTogglableFeature implements SimpleListener {

    public AntiFireOverlayFeature() {
        super("AntiFireOverlay", AsunaCategory.RENDER);
    }
